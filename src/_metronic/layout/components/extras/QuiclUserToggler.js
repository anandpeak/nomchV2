      ...
      <div className="topbar-item">
        <div className="btn btn-icon w-auto btn-clean d-flex align-items-center btn-lg px-2"
          ...
          <>
            ...
            <span className="text-muted font-weight-bold font-size-base d-none d-md-inline mr-1">Болдсайхан</span>
            <span className="text-dark-50 font-weight-bolder font-size-base d-none d-md-inline mr-3">
              {/* {user.fullname} */}
            </span>
            <span className="symbol symbol-35 symbol-light-success">
              {/* <span className="symbol-label font-size-h5 font-weight-bold">{user.fullname[0]}</span> */}
              <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcTWKfiwjCSvgs5NQUSxpyx7jhxWDl5LrVpQ036rm_0kuIzNNuPc&usqp=CAU" className="symbol-label font-size-h5 font-weight-bold"></img>
