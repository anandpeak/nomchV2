...
import { translations } from '../../../_metronic/util/translations';
...
class ExamDashboard extends React.Component {
    constructor(props) {
        ...
        this.columns = [
            ...
            {
                key: "date",
                text: translations(this.state.locale).exam.date,
                align: "center",
            },
            {
                key: "name",
                text: translations(this.state.locale).exam.name,
                sortable: true,
                clickableTd: true,
            ...
            {
                key: "totalScore",
                text: translations(this.state.locale).exam.score,
                sortable: true,
            },
            {
                key: "takenScore",
                text: translations(this.state.locale).exam.taken_score,
                sortable: true,
            },
            {
                key: "quality",
                text: translations(this.state.locale).exam.ranking,
                sortable: true,
            },
        ];
        ...
        this.subjectColumns = [
            ...
            {
                key: "groupName",
                text: translations(this.state.locale).subject.title,
            },
            {
                key: "score",
                text: translations(this.state.locale).exam.score,
            ...
            {
                key: "performance",
                text: translations(this.state.locale).exam.performance,
            },
            {
                key: "ranking",
                text: translations(this.state.locale).exam.ranking,
        ...
        this.assignmentColumns = [
            ...
            {
                key: "assignment",
                text: translations(this.state.locale).exam.assignment,
            },
            {
                key: "score",
                text: translations(this.state.locale).exam.score,
    ...
    componentDidMount() {
        ...
        this.setState({
            dataTreeToShow: initTreeData,
            seasons: examInitData.data.seasons,
        })
    }
            ...
            <div className="row">
                <div className="col-lg-12">
                            ...
                            <div className="row">
                                ...
                                <div className="col-md-8 px-md-2">
                                    ...
                                    <div className="p-3 mt-3 shadow-sm">
                                        <DataTable
                                            className="table table-bordered hdrBlue"
                                            config={this.config}
                    ...
                    {this.state.showModal && (
                        <ModalMain
                            title={translations(this.state.locale).subject.title}
                        ...
                        >
                            <div className="row h-70 shadow-sm">
                                <div className="col-md-2 px-md-0">
                                    <div className="p-3 ">
                                        <ExamModalMixedWidget locale={this.state.locale} />
                                    </div>
                                </div>
                                    ...
                                    <div className="p-3 ">
                                        <div className="row">
                                            <div className="col-sm-7 pt-3 examModelTxtToRight">
                                                <span>{translations(this.state.locale).exam.taken_date}</span>
                                            </div>
                                        ...
                                        <div className="row">
                                            <div className="col-sm-7 pt-3 examModelTxtToRight">
                                                <span>{translations(this.state.locale).exam.name}</span>
                                            </div>
                                            <div className="col-sm-5 pt-3 examModelTxtToLeft">
                                        ...
                                        <div className="row">
                                            <div className="col-sm-7 pt-3 examModelTxtToRight">
                                                <span>{translations(this.state.locale).exam.score}</span>
                                            </div>
                                            <div className="col-sm-5 pt-3 examModelTxtToLeft">
                                        ...
                                        <div className="row">
                                            <div className="col-sm-7 pt-3 examModelTxtToRight">
                                                <span>{translations(this.state.locale).exam.taken_score}</span>
                                            </div>
                                            <div className="col-sm-5 pt-3 examModelTxtToLeft">
                                        ...
                                        <div className="row">
                                            <div className="col-lg-7 pt-3 examModelTxtToRight">
                                                <span>{translations(this.state.locale).exam.ranking}</span>
                                            </div>
                                ...
                                <div className="col-md-5 px-md-2">
                                    <div className="p-3 h-100 ">
                                        <div className="row">
                                            <div className="col-lg-6 pt-3 examModelTxtToRight">
                                                <span>{translations(this.state.locale).exam.detail}</span>
                                            </div>
                                            <div className="col-lg-6 pt-3 examModelTxtToLeft">
                                        ...
                                        <div className="row">
                                            <div className="col-lg-6 pt-3 examModelTxtToRight">
                                                <span>{translations(this.state.locale).exam.pay_attention}</span>
                                            </div>
                                            <div className="col-lg-6 pt-3 examModelTxtToLeft">
                                                <span></span>
                                            </div>
    ...
    renderTabs() {
        const tabRows = this.state.seasons.map(season => <Tab key={season.seasonId} label={<span>{season.seasonName}</span>}/>)
    ...
    onTreeSelected = (idArray) => {
        ...
        this.setState({
            initRecordToShow: tmpArr,
            groupAvg,
            selfAvg,
            dateList,
            examDetail: examDetailData.data.exam
        })
    }
}
